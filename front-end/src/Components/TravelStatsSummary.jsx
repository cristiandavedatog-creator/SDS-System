...
// Numeric counterpart to the LineGraph/Pie charts: a chosen year's total,
// a chosen month's total, and the current week's total, as plain numbers.
const TravelStatsSummary = () => {
  const now = new Date();
  ...
  const fetchStats = useCallback(async () => {
    try {
      const res = await axios.get(`${baseURL}/api/travels/stats`, {
